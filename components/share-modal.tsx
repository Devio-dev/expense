...
export function ShareModal({ personId, personName, onClose }: ShareModalProps) {
  ...
  const generateShareLink = useCallback(() => {
    try {
      ...
      // Guardar el enlace en localStorage para futuras referencias
      try {
        ...
        links.push(newLink)
        localStorage.setItem("loanTracker_sharedLinks", JSON.stringify(links))
      } catch (error) {
        console.error("Error al guardar el enlace compartido:", error)
      }
  ...
  }, [personId, personName, expiryDays, includeTransactions, includePersonalInfo, requirePassword])
